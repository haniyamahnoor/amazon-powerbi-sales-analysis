...
Product Attributes: Product name, brand, main category, sub-category

Pricing & Discounts: Price, discount percent, final price

Customer Details: Region, age group

Purchase Behaviour: Device type, payment method

Order Information: Order date, delivery days, quantity

Feedback Metrics: Review rating, return status
...
The Calendar table includes Year, Month, Quarter, and Weekday columns to enable time-series analysis.

Relationships were built using Order Date as the key.
...
Women’s category generated the highest revenue, followed by Men’s clothing.
